                            ...
                            <Card key={item.id} className="p-3 flex items-center gap-4">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Masuk: {item.checkInTime.toDate().toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' })}
                                        {item.checkOutTime ? ` | Keluar: ${item.checkOutTime.toDate().toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' })}` : ''}
                                    </p>
                                </div>
                                <Badge variant={
